...
// File#: controll on/off

document.getElementById('themeSwitch').addEventListener('change', function (event){
  (event.target.checked) ? document.getElementById('on/off').innerText = 'On' : document.getElementById('on/off').innerText = 'Off';
});

// File#: modalità preferita
function somma() {
  light = document.percentual.light_mode.value;
  dark= document.percentual.dark_mode.value;
  document.percentual.star.innerText= light + dark;
}
